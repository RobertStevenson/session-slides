...
- Building a Reusable UI Library with Web Components
- Button Masher to Code Master – Unity3D Workshop
- Career Conversations: The Missing Skill No One Teaches You
- Demystifying Generative AI
- Mob / Ensemble Programming Workshop
- SQL Server Query Store Masterclass: From Troubleshooting to Optimization
